...
$_SESSION['productID'] = $serial_number;
#print $_SESSION['productID'];
?>
...
<html>
	...
	<?php
		if($_SESSION['Logged_in_user']){
			...
			print "<br><p><a href='homePage.php'>Back to Products</a></p>";
		} else {
		...
		<table class="list" border="1" name="Products">
			...
			while ($data = mysqli_fetch_assoc($dataSet)) { ?>
				...
				<?php 
					...
					$_SESSION['p_SN'] = $data['serial_number'];
					$_SESSION['p_name'] = $data['name'];
					$_SESSION['p_price'] = $data['price'];
					$_SESSION['p_description'] = $data['description'];
